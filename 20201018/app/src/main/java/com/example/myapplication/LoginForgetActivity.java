...
public class LoginForgetActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_verifycode).setOnClickListener((View.OnClickListener) this);
        findViewById(R.id.btn_confirm).setOnClickListener((View.OnClickListener) this);
