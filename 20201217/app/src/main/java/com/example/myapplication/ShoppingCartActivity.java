...
import com.example.myapplication.bean.GoodsInfo2;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showCart() {
        ...
        for (int i = 0; i < mCartArray.size(); i++) {
            ...
            iv_thumb.setImageBitmap(com.example.myapplication.MainApplication.getInstance().mIconMap.get(info.goods_id));
